	...
	<div class="header">
		...
		<div class="container" >
			...
			<div class="row">
				...
				<div  class="col-md-4">
					<a style="width: 100%; text-align: center; " href="addtheater.php" class="myButton">Add Theater </a>
				</div>
				<div  class="col-md-4">
					<a style="width: 100%; text-align: center; " href="addTimeSlot.php" class="myButton"> Add Time Slot </a>
				</div>
			</div> 
